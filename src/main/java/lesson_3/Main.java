...
public class Main {
    static void main(String[] args) {
        ...
        Park park = new Park("FunZone", null, "9:00-22:00");
        Park.Address address = park.new Address("Москва", "Парковая", "15");
        park.parkInfo(address);

        Park.Attraction[] attractions = new Park.Attraction[4];
        attractions[0] = park.new Attraction("Американские горки", "10:00-20:00", 250);
        attractions[1] = park.new Attraction("Колесо обозрения", "9:00-22:00", 130);
        attractions[2] = park.new Attraction("Комната страха", "9:30-21:00", 190);
        attractions[3] = park.new Attraction("Автодром", "9:30-21:30", 150);
        for (int j = 0; j < 4; j++) {
